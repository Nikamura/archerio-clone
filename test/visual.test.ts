...
describe("Visual Tests", () => {
  ...
  it("should spawn enemies in the game", async () => {
    ...
    const enemyLogs = logs.filter((log) => log.includes("Spawned") || log.includes("Enemy"));
  ...
  it("should respond to player movement input", async () => {
    ...
    const movementErrors = recentErrors.filter(
      (e) => e.includes("movement") || e.includes("velocity"),
    );
