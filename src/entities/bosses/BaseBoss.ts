...
export default abstract class BaseBoss extends Enemy {
  ...
  protected clampToWorldBounds(): void {
    ...
    this.x = Phaser.Math.Clamp(this.x, this.worldBounds.left + margin, this.worldBounds.right - margin)
    this.y = Phaser.Math.Clamp(this.y, this.worldBounds.top + margin, this.worldBounds.bottom - margin)
  }
