...
export default class GameScene extends Phaser.Scene {
  ...
  private updateRoomUI() {
    if (this.isEndlessMode) {
      ...
      this.scene
        .get("UIScene")
        .events.emit("updateRoom", this.currentRoom, this.totalRooms, this.endlessWave);
    } else {
  ...
  private spawnBoss() {
    ...
    this.scene
      .get("UIScene")
      .events.emit("showBossHealth", this.boss.getHealth(), this.boss.getMaxHealth(), bossName);
  ...
  private spawnMiniBoss() {
    ...
    this.scene
      .get("UIScene")
      .events.emit("showBossHealth", this.boss.getHealth(), this.boss.getMaxHealth(), miniBossName);
